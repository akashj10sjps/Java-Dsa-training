package com.advanced.dsa.dataStructures.nonLinear.graphs.algorithms.toposort.dijkstras;

import java.util.*;

public class DijkstraAlgorithm {
    public static List<Integer> dijkstraAlgorithm(int V,List<List<Pair>> adj,int S){
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < V; i++) {
            adj.add(new ArrayList<>());//Adding new empty Arrays for storage
        }
        ...
        List<Integer> shortestDistanceArray=dijkstraAlgorithm(V,adj,S);
